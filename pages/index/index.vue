<template>
    <view class="container">
        ...
        <view class="carousel-section">
            ...
            <!-- 滚动banner -->
            <swiper class="carousel" :autoplay="autoplay" circular @change="swiperChange">
        ...
        <view class="seckill-section m-t">
            <view class="s-header">
                ...
                <text class="hour timer">00</text>
                <text class="minute timer">00</text>
                <text class="second timer">00</text>
                <!-- 右标签 -->
        ...
        <view class="hot-floor">
            <view class="floor-img-box">
                <image class="floor-img" src="https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=4095936169,1660418379&fm=26&gp=0.jpg"
                    mode="scaleToFill"></image>
            </view>
            <scroll-view class="floor-list" scroll-x>
                <view class="scoll-wrapper">
