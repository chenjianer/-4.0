    ...
    <view class="container">  
		...
		<view class="user-section">
			...
			<view class="vip-card-box">
				...
				<text class="e-m">商城黄金会员</text>
				<text class="e-b">开通会员可享优惠，每月还赠送福利哦</text>
			</view>
		</view>
		...
		>
			...
			<view class="history-section icon">
				...
				<list-cell icon="icon-iconfontweixin" iconColor="#e07472" title="我的钱包" tips="您的会员还有1天过期"></list-cell>
				<list-cell icon="icon-dizhi" iconColor="#5fcda2" title="地址管理" @eventClick="navTo('/pages/address/address')"></list-cell>
				<list-cell icon="icon-share" iconColor="#9789f7" title="分享" tips="邀请好友赢百万大礼"></list-cell>
